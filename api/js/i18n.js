...
(function (window) {
  ...
  const dict = {
    ru: {
      ...
      'members.birth_date': 'Дата рождения',
      'members.photo': 'Фото',
      ...
      'search.source.event': 'Мероприятие',
      'search.source.comment': 'Комментарий',
      ...
      'letters.delete_confirm_bulk': 'Удалить {n} писем(а)? Они будут перемещены в архив.',
      'letters.deleted_ok': 'Удалено: {n}',
      'letters.batch_delete': 'Удалить',
    ...
    kz: {
      ...
      'search.source.event': 'Іс-шара',
      'search.source.comment': 'Пікір',
      ...
      'letters.delete_confirm_bulk': '{n} хатты жою керек пе? Олар мұрағатқа жылжытылады.',
      'letters.deleted_ok': 'Жойылды: {n}',
      'letters.batch_delete': 'Жою',
