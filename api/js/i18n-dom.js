...
(function (window) {
  ...
  const extra = {
    ru: {
      ...
      'nav.my_letters': 'Мои письма',
      'nav.appeals': 'Обращения',
      'nav.archive': 'Архив',
      'nav.whats_new': 'Что нового',
      ...
      'notify.rt.overdue_days': 'срок просрочен на {days} дн.',
      'notify.rt.until_deadline': 'до дедлайна {days} дн.',
      'notify.rt.due': 'срок',
      ...
      'tg.link_title': 'Привязать Telegram',
      'tg.generating': 'Генерация кода…',
      'tg.send_command': 'Отправьте боту следующую команду:',
      'tg.copy': 'Скопировать',
      'tg.code_valid_1': 'Код действителен',
      'tg.code_10min': '10 минут',
      'tg.code_valid_2': '. Откройте бота и отправьте команду выше.',
      'tg.open_bot': 'Открыть бота в Telegram',
      'profile.title': 'Мой профиль',
      'profile.login': 'Логин',
      'profile.display_name': 'Отображаемое имя',
      'profile.email': 'Email',
      'profile.change_pass_hint': 'Смена пароля (оставьте пустым, если не хотите менять)',
      'profile.current_pass': 'Текущий пароль',
      'profile.new_pass': 'Новый пароль',
      'profile.min8': '(мин. 8 символов)',
      'profile.sessions': 'Активные сессии',
      'profile.terminate_all': 'Завершить все другие сессии',
      'profile.th_device': 'Устройство / браузер',
      'profile.th_last_active': 'Последняя активность',
      'archive.title': 'Архив писем',
      'archive.subtitle': 'Удалённые письма. Только администратор может восстановить.',
      'search.scope_all': 'Все',
      'search.scope_letters': 'Письма',
      'search.scope_members': 'Члены ОС',
      'search.scope_archived': 'Архив',
      'updates.title': 'Что нового в системе',
      'updates.subtitle': 'Последние улучшения Журнала Общественного Совета',
      'updates.rel_jun': 'Июнь 2026',
      'updates.rel_major': 'Крупное обновление',
      'updates.rel_older': 'Ранее',
      'updates.rel_prev': 'Предыдущие обновления',
      'updates.c1_h': 'Приложение теперь работает как мобильное',
      'updates.c1_p': 'Журнал можно установить на экран телефона или планшета — как обычное приложение. При потере интернета вместо белого экрана появляется страница «Нет соединения».',
      'updates.c2_h': 'Кнопка «Распечатать» на каждом письме',
      'updates.c2_p1': 'В таблице входящих и исходящих появилась кнопка',
      'updates.c2_p2': '. Нажмите — откроется готовая форма письма для печати: с реквизитами, темой, ответственными и сроком.',
      'updates.c3_h': 'Групповые действия с письмами',
      'updates.c3_p': 'Теперь можно выбрать несколько писем сразу — появятся чекбоксы в каждой строке. Отметив нужные, вы можете скачать их одним файлом.',
      'updates.c4_h': 'Тёмная тема',
      'updates.c4_p1': 'В правом верхнем углу появился переключатель',
      'updates.c4_p2': '. Нажмите — интерфейс переключится в тёмный режим. Выбор сохраняется при следующем входе.',
      'updates.c5_h': 'Экспорт в Excel',
      'updates.c5_p1': 'Рядом с кнопками «CSV» и «PDF» появилась кнопка',
      'updates.c5_p2': '. Скачивает все письма в таблицу Excel (.xlsx) — удобно для отчётов и распечатки.',
      'updates.c6_h': 'Двухфакторная защита входа (2FA)',
      'updates.c6_p': 'Администраторы могут подключить защиту через приложение Google Authenticator. При входе кроме пароля нужно ввести одноразовый 6-значный код — так аккаунт защищён, даже если пароль попал к посторонним. Настройка — в Админ-панели → Система.',
      'updates.c7_h': 'Улучшенный мониторинг системы',
      'updates.c7_p': 'В Админ-панели раздел «Состояние системы» теперь показывает: сколько памяти использует сервер, статус почтовой очереди, размер загруженных файлов и когда последний раз выполнялась автоматическая рассылка напоминаний.',
      'updates.c8_h': 'Email-уведомления о просроченных письмах',
      'updates.c8_p': 'Система автоматически отправляет напоминание ответственным членам ОС, если срок ответа на письмо истекает или уже прошёл.',
      'updates.c9_h': 'Импорт писем из CSV',
      'updates.c9_p': 'Теперь можно загрузить сразу много писем из таблицы CSV. Кнопка «Импорт CSV» находится в верхнем меню.',
      'updates.c10_h': 'Фото и статистика членов ОС',
      'updates.c10_p': 'У каждого члена Общественного совета можно загрузить фотографию. Страница члена показывает, сколько писем за ним закреплено, сколько просрочено и по каким комиссиям.',
      'updates.c11_h': 'Казахский язык интерфейса',
      'updates.c11_p': 'Переключатель языка в боковом меню — интерфейс полностью переведён на казахский язык.',
      'updates.c12_h': 'Графики и KPI на дашборде',
      'updates.c12_p': 'Главная страница показывает активность по месяцам, статистику по категориям и рейтинг вовлечённости членов ОС.',
      'updates.footer': 'Все вопросы и пожелания по работе системы — обращайтесь к администратору.',
      'tpl.preview': 'Предпросмотр',
      'tpl.apply': 'Применить шаблон',
      'tpl.preview_empty': 'Шаблон не содержит текста',
      'tpl.field_org': 'Организация',
      'tpl.field_subject': 'Тема',
      'tpl.field_note': 'Примечание',
      'tpl.vars_title': 'Переменные в тексте шаблона',
    ...
    kz: {
      ...
      'nav.my_letters': 'Менің хаттарым',
      'nav.appeals': 'Өтініштер',
      'nav.archive': 'Мұрағат',
      'nav.whats_new': 'Жаңалықтар',
      'dash.members_label': 'Кеңес мүшелері',
      'common.status': 'Күйі',
      'letters.kk_number': 'Тіркеу нөмірі',
      'members.stats': 'Статистика',
      'members.stat_response_rate': 'Жауап пайызы',
      ...
      'members.stat_no_letters': 'Хаттар тағайындалмаған',
      'notify.browser.overdue_title': 'ОС журналы — Мерзімі өткен хаттар',
      'notify.browser.overdue_body': '{n} хаттың мерзімі өткен',
      'notify.browser.due_soon_title': 'ОС журналы — Мерзім аяқталуда',
      'notify.browser.due_soon_body': '{n} хат жақын арада жауап талап етеді',
      'notify.rt.overdue_days': 'мерзімі {days} күнге өткен',
      'notify.rt.until_deadline': 'мерзімге дейін {days} күн',
      'notify.rt.due': 'мерзім',
      'search.source.archive_incoming': 'Мұрағат · Кіріс',
      'search.source.archive_outgoing': 'Мұрағат · Шығыс',
      'common.export': 'Экспорт',
      'skip.content': 'Мазмұнға өту',
      'tg.link_title': 'Telegram-ды байланыстыру',
      'tg.generating': 'Код жасалуда…',
      'tg.send_command': 'Ботқа келесі команданы жіберіңіз:',
      'tg.copy': 'Көшіру',
      'tg.code_valid_1': 'Код жарамды:',
      'tg.code_10min': '10 минут',
      'tg.code_valid_2': '. Ботты ашып, жоғарыдағы команданы жіберіңіз.',
      'tg.open_bot': 'Ботты Telegram-да ашу',
      'profile.title': 'Дербес бетім',
      'profile.login': 'Логин',
      'profile.display_name': 'Көрсетілетін аты',
      'profile.email': 'Email',
      'profile.change_pass_hint': 'Құпиясөзді ауыстыру (өзгертпесеңіз бос қалдырыңыз)',
      'profile.current_pass': 'Ағымдағы құпиясөз',
      'profile.new_pass': 'Жаңа құпиясөз',
      'profile.min8': '(кемінде 8 таңба)',
      'profile.sessions': 'Белсенді сессиялар',
      'profile.terminate_all': 'Барлық басқа сессияларды аяқтау',
      'profile.th_device': 'Құрылғы / браузер',
      'profile.th_last_active': 'Соңғы белсенділік',
      'archive.title': 'Хаттар мұрағаты',
      'archive.subtitle': 'Жойылған хаттар. Тек әкімші қалпына келтіре алады.',
      'search.scope_all': 'Барлығы',
      'search.scope_letters': 'Хаттар',
      'search.scope_members': 'Кеңес мүшелері',
      'search.scope_archived': 'Мұрағат',
      'updates.title': 'Жүйедегі жаңалықтар',
      'updates.subtitle': 'Қоғамдық кеңес журналының соңғы жақсартулары',
      'updates.rel_jun': '2026 маусым',
      'updates.rel_major': 'Ірі жаңарту',
      'updates.rel_older': 'Бұрын',
      'updates.rel_prev': 'Алдыңғы жаңартулар',
      'updates.c1_h': 'Қосымша енді мобильді қосымша ретінде жұмыс істейді',
      'updates.c1_p': 'Журналды телефон немесе планшет экранына кәдімгі қосымша сияқты орнатуға болады. Интернет үзілгенде ақ экранның орнына «Байланыс жоқ» беті көрсетіледі.',
      'updates.c2_h': 'Әр хатта «Басып шығару» батырмасы',
      'updates.c2_p1': 'Кіріс және шығыс кестесінде батырма пайда болды',
      'updates.c2_p2': '. Басыңыз — хаттың басып шығаруға дайын нысаны ашылады: деректемелерімен, тақырыбымен, жауаптыларымен және мерзімімен.',
      'updates.c3_h': 'Хаттармен топтық әрекеттер',
      'updates.c3_p': 'Енді бірнеше хатты бірден таңдауға болады — әр жолда белгілеу ұяшықтары пайда болады. Қажеттілерін белгілеп, оларды бір файлмен жүктеп алуға болады.',
      'updates.c4_h': 'Қараңғы режим',
      'updates.c4_p1': 'Жоғарғы оң жақ бұрышта ауыстырғыш пайда болды',
      'updates.c4_p2': '. Басыңыз — интерфейс қараңғы режимге ауысады. Таңдау келесі кіргенде сақталады.',
      'updates.c5_h': 'Excel-ге экспорттау',
      'updates.c5_p1': '«CSV» және «PDF» батырмаларының қасында батырма пайда болды',
      'updates.c5_p2': '. Барлық хаттарды Excel (.xlsx) кестесіне жүктейді — есептер мен басып шығаруға ыңғайлы.',
      'updates.c6_h': 'Кіруді екі факторлы қорғау (2FA)',
      'updates.c6_p': 'Әкімшілер Google Authenticator қосымшасы арқылы қорғанысты қоса алады. Кірген кезде құпиясөзден бөлек бір реттік 6 таңбалы кодты енгізу қажет — осылайша тіркелгі құпиясөз бөгде адамдарға түссе де қорғалады. Баптау — Әкімші тақтасында → Жүйе.',
      'updates.c7_h': 'Жетілдірілген жүйе мониторингі',
      'updates.c7_p': 'Әкімші тақтасында «Жүйе жағдайы» бөлімі енді көрсетеді: сервер қанша жад пайдаланатынын, пошта кезегінің күйін, жүктелген файлдар көлемін және еске салулардың автоматты таратылымы соңғы рет қашан орындалғанын.',
      'updates.c8_h': 'Мерзімі өткен хаттар туралы Email-хабарламалар',
      'updates.c8_p': 'Хатқа жауап беру мерзімі аяқталып жатса немесе өтіп кетсе, жүйе жауапты кеңес мүшелеріне автоматты түрде еске салу жібереді.',
      'updates.c9_h': 'CSV-ден хаттарды импорттау',
      'updates.c9_p': 'Енді CSV кестесінен бірден көп хатты жүктеуге болады. «CSV импорты» батырмасы жоғарғы мәзірде орналасқан.',
      'updates.c10_h': 'Кеңес мүшелерінің фотосы мен статистикасы',
      'updates.c10_p': 'Әр Қоғамдық кеңес мүшесіне фотосурет жүктеуге болады. Мүше беті оған қанша хат бекітілгенін, қаншасының мерзімі өткенін және қай комиссиялар бойынша екенін көрсетеді.',
      'updates.c11_h': 'Интерфейстің қазақ тілі',
      'updates.c11_p': 'Бүйірлік мәзірдегі тіл ауыстырғышы — интерфейс толығымен қазақ тіліне аударылған.',
      'updates.c12_h': 'Бақылау тақтасындағы графиктер мен KPI',
      'updates.c12_p': 'Басты бет айлар бойынша белсенділікті, санаттар бойынша статистиканы және кеңес мүшелерінің қатысу рейтингін көрсетеді.',
      'updates.footer': 'Жүйе жұмысы бойынша барлық сұрақтар мен ұсыныстар — әкімшіге хабарласыңыз.',
      'tpl.preview': 'Алдын ала қарау',
      'tpl.apply': 'Үлгіні қолдану',
      'tpl.preview_empty': 'Үлгіде мәтін жоқ',
      'tpl.field_org': 'Ұйым',
      'tpl.field_subject': 'Тақырып',
      'tpl.field_note': 'Ескертпе',
      'tpl.vars_title': 'Үлгі мәтініндегі айнымалылар',
      'tpl.vars_body': 'Қолдау көрсетілетін плейсхолдерлер: {номер}, {организация}, {дата}, {тема} (немесе {number}, {organization}, {date}, {subject}). Қолдану кезінде олар ағымдағы хат формасының мәндерімен ауыстырылады; толтырылмағандары — ___ белгісімен қалады.',
    },
  };
  ...
  const DOM_MAP = [
    ...
    ['#templatePreviewTitle', 'tpl.preview'],
    ['#btnApplyTemplate', 'tpl.apply'],
    ['#templateVarsHintTitle', 'tpl.vars_title'],
